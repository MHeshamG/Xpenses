...
class DotIndicatorDecoration(context: Context):RecyclerView.ItemDecoration() {
    ...
    private val selectedColor: Int = ContextCompat.getColor(context, R.color.colorAccent)
    private val unselectedColor: Int = ContextCompat.getColor(context, R.color.colorPrimary)
